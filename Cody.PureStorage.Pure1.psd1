...
@{
	...
	AliasesToExport = 'New-PureOneRestConnection','Get-PureOneArrays','New-PureOneRestOperation','Get-PureOneArrayTags','Set-PureOneArrayTags','Remove-PureOneArrayTags','Get-PureOneArrayNetworking','Get-PureOneMetricDetails','Get-PureOneMetrics','Get-PureOneVolumes','Get-PureOnePods','Get-PureOneVolumeSnapshots','Get-PureOneFileSystems','Get-PureOneFileSystemSnapshot','Get-PureOneArrayBusyMeter'
